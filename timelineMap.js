function init(){
	...
	var hardrada=new dataPoint(sc, "King Hardrada of Norway", '1046', '1066');
	...
	var text39 = new dataInfoText("Germanic tribes living around the North Sea begin to add Norse-like runes to their alphabet to deal with sound changes in their dialects, creating the Anglo-Frisian Futhork.");
	var text40 = new dataInfoText('Lives of the historical antecedents of Beowulf, Hrothgar and Hrolf Kraki are dated to this time. </br>See a summary of Beowulf, the earliest remaining Anglo-Saxon Poem: <embed width="100%" height="300px" src="https://www.youtube.com/v/8SiarUS3ddA" type="application/x-shockwave-flash" allowfullscreen="true">');
